    ...
    <div class="flex justify-center items-center flex-grow">
      <div class="w-full max-w-md px-4 sm:px-0">
        ...
        <div class="mb-8 flex justify-between items-center gap-2">
          <div class="text-end">
            <span class="text-4xl font-extrabold">Calendário Subathônico</span><br>
            <span v-if="momentbr().month() === birthdayMonth" class="text-sm bg-pink-300 px-2 py-1 rounded-full inline-flex cursor-default">
              <svg  xmlns="http://www.w3.org/2000/svg"  width="16"  height="16"  viewBox="0 0 24 24"  fill="currentColor"  class="icon icon-tabler icons-tabler-filled icon-tabler-balloon"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 1a7 7 0 0 1 7 7c0 5.457 -3.028 10 -7 10c-3.9 0 -6.89 -4.379 -6.997 -9.703l-.003 -.297l.004 -.24a7 7 0 0 1 6.996 -6.76zm0 4a1 1 0 0 0 0 2l.117 .007a1 1 0 0 1 .883 .993l.007 .117a1 1 0 0 0 1.993 -.117a3 3 0 0 0 -3 -3z" /><path d="M12 16a1 1 0 0 1 .993 .883l.007 .117v1a3 3 0 0 1 -2.824 2.995l-.176 .005h-3a1 1 0 0 0 -.993 .883l-.007 .117a1 1 0 0 1 -2 0a3 3 0 0 1 2.824 -2.995l.176 -.005h3a1 1 0 0 0 .993 -.883l.007 -.117v-1a1 1 0 0 1 1 -1z" /></svg>
              &nbsp;aniversário
            </span>
          </div>

          <img src="/img/meiaBirthday.svg" width="98" alt="PET THE PEEPO MEIAUM">
        </div>
...
<script setup lang="ts">
  ...
  function isBirthday(day: number) {
    ...
    if(isTheDay) {
      ...
      const year = birthday.isAfter(today) || birthday.isSame(today) ? birthday.year() : birthday.year() + 1;
